...
var DropboxSaver = /*#__PURE__*/function (_Component) {
  _inheritsLoose(DropboxSaver, _Component);
  ...
  function DropboxSaver(props) {
    ...
    _this.isDropboxReady = function () {
      return !!window.Dropbox;
    };

    _this.onSave = function () {
      if (!_this.isDropboxReady() || _this.props.disabled) {
        return null;
      }
    };
  ...
  var _proto = DropboxSaver.prototype;
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    if (!this.isDropboxReady() && !scriptLoadingStarted) {
      ...
      loadScript(DROPBOX_SDK_URL, {
        ...
        if (err) console.log("script not added");else {
          var button = window.Dropbox.createSaveButton(_this2.props);
